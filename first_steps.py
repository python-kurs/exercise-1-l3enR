...
frequency = 5.0E+14
v_3 = (speed_of_light / frequency)*10.0E+12
v_3 = int(v_3)
maximum = 690
minimum = 380
sichtbar = v_3 > minimum and v_3 < maximum

print("Der Wellenlängenbereich ist sichtbar:")
print(sichtbar)
...
print("Pi rounded to the first 10 decimals is: {0:11.10f}".format(pi))
# ------------------------------------
